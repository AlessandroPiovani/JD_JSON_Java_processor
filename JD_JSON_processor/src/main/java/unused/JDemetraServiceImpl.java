...
public class JDemetraServiceImpl {
    ...
    public String process(SeasonalData datiSerie, Long id) throws Exception {
    ...
    private String processTSspec(SeasonalData datiSerie) {
        TramoSeatsSpecification specifications=null;
        ...
        try {
            ...
            TSmodelSetup setup = new TSmodelSetup(model);
